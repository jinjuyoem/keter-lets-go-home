...
const test = async () => {
    ...
    try {
        const response = await axios.get('https://api.naver.com' + uri + '?hintKeywords=' + encodeURIComponent(hintKeywords) + '&showDetail=1', {
            headers: {
        ...
        console.log("나이키 Volume:", response.data.keywordList[0]);
    } catch (e) {
